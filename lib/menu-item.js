    ...
    "li",
    {
      ...
      on: {
        ...
        mouseup: function($event) {
          ...
          return _vm.handleMiddleClick($event)
        }
      }
    },
    [
      _c(
        "el-popover",
        {
          on: { blur: _vm.resetLeft },
          model: {
            value: _vm.openRight,
            callback: function($$v) {
              _vm.openRight = $$v
            },
            expression: "openRight"
          }
        },
        [
          _c("div", { on: { click: _vm.handleMiddleClick } }, [
            _vm._v("\n      Открыть\n    ")
          ])
        ]
      ),
...
/* harmony default export */ var menu_itemvue_type_script_lang_js_ = ({
  ...
  methods: {
    ...
    handleMiddleClick: function handleMiddleClick() {
